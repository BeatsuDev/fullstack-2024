...
export const ImageApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async uploadImage(options?: AxiosRequestConfig): Promise<AxiosResponse<Image>> {
            return ImageApiFp(configuration).uploadImage(options).then((request) => request(axios, basePath));
        },
    };
};
