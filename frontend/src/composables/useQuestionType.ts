...
export default function useQuestionType(question: Ref<QuestionCreate | Question>) {
...
export function isBoolean(question) {
    ...
    return question.options[0].text === "True" && question.options[1].text === "False";
}

export function removeFieldsNotInType(question: QuestionCreate | Question, questionType: keyof typeof QuestionTypes) {
